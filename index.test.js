...
describe('Equal search', () => {
  ...
  it('expect 77 when searching 77 in [0...99]', () => expect(equalSearch(numbers, 77)).toBe(77));
...
describe('Closest search', () => {
  ...
  it('expect 7 when searching 6.8 in [0...99]', () => expect(closestSearch(numbers, 6.9)).toBe(7));
  ...
  it('expect 77 when searching 76.8 in [0...99]', () => expect(closestSearch(numbers, 76.8)).toBe(77));
